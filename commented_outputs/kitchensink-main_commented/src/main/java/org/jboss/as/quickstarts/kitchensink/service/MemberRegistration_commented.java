...
@Service
/**
 * The MemberService class provides functionality for managing member data 
 * within the application, including operations for creating, updating, 
 * and retrieving member information from a MongoDB database.
 */
...
/**
 * Generates a new sequence number for a given sequence name.
 *
