...
/**
 * This class provides test utilities for the Kitchensink application, facilitating the validation and manipulation of JSON data 
 * related to member entities. It streamlines the testing process by offering methods to create and verify JSON representations 
 * of member objects. 
 */
...
/**
 * Retrieves HTTP endpoint URI for members API.
 *
 * @return URI of members API
 */
...
/**
 * Retrieves server host from environment variable or system property.
 *
 ...
 */
    ...
    @Test
/**
 * Tests registration of a new member.
 *
 ...
 */
    ...
    @AfterEach
/**
 * Cleans up test member if created ID exists.
 *
